...
public class TalkerHelper {
    ...
    public void printDiagnosticDetails()
    {
        ...
        System.out.println(Color.RESET);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "***************************************************************************");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "***************************************************************************");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "STATISTICS");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "***************************************************************************");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "***************************************************************************");
        System.out.println();
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "[General Statistics]");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Time elapsed: " + dateDiffValRounded[2] + " hours, " + dateDiffValRounded[1] + " minutes, " + dateDiffValRounded[0] + " seconds");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Available Memory: " + Runtime.getRuntime().freeMemory()+"/" +Runtime.getRuntime().maxMemory());
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Available Processor: " + Runtime.getRuntime().availableProcessors());
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of threads: " + Thread.getAllStackTraces().keySet().size());
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Number of threads currently running: " + this.getRunningThreads());
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "---------------------------------------------------------------------------------");
        System.out.println();
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "[IP Statistics]");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of IP's generated: " + Statistics.totalIPGenerated);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of IP's up: " + Statistics.totalIPUp);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of IP's scanned: " + Statistics.totalIPScanned);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Average IP's scans per hour: " + ( dateDiffValExact[2] == 0 ? Statistics.totalIPScanned : ( Precision.round((double) Statistics.totalIPScanned / dateDiffValExact[2], 2))));
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of IP's found with with Telnet port open: " + Statistics.totalIPTelnetPortsOpen);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of IP's found with with SSH port open: " + Statistics.totalIPSSHPortOpen);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "---------------------------------------------------------------------------------");
        System.out.println();
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "[Telnet Statistics]");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of vulnerable Telnet servers: " + Statistics.totalVulnerableTelnetServer);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of Telnet servers with direct shell access (no auth): " + Statistics.totalTelnetNoAuthDirectShell);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of unknown authentication Telnet servers: " + Statistics.totalUnknownTelnetAuth);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of refused connections for Telnet servers: " + Statistics.totalTelnetConnectionRefused);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Average vulnerable Telnet servers per hour: " + ( dateDiffValExact[2] == 0 ? Statistics.totalVulnerableTelnetServer : ( Precision.round((double) Statistics.totalVulnerableTelnetServer / dateDiffValExact[2],2))));
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "---------------------------------------------------------------------------------");
        System.out.println();
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "[SSH Statistics]");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of clean vulnerable SSH servers: " + Statistics.totalCleanVulnerableSSHServer);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of (unchecked) vulnerable SSH servers : " + Statistics.totalVulnerableSSHServer);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of pending vulnerable SSH servers: " + SSHVulnerableValidationHelper.getSharedVulnerableSSHList().size());
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of false positive vulnerable SSH servers: " + Statistics.totalFalsePositiveSSHServer);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Total number of aborted by SSH servers: " + Statistics.totalConnectionFailedAndAbortedSSHServer);
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "Average vulnerable SSH servers per hour: " + ( dateDiffValExact[2] == 0 ? Statistics.totalCleanVulnerableSSHServer : ( Precision.round((double) Statistics.totalCleanVulnerableSSHServer / (double) dateDiffValExact[2],2))));
        System.out.println();
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "***************************************************************************");
        System.out.println(Color.BLACK_BACKGROUND_GREEN_FOREGROUND + "***************************************************************************");
    }
